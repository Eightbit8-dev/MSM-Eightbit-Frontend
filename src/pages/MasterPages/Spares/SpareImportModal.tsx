...
import { useImportSpares } from "../../../queries/masterQueries/SpareQuery";
...
const SpareImportModal = ({ isOpen, onClose }: ImportModalProps) => {
  const [selectedFile, setSelectedFile] = useState<File | null>(null);
  const { mutate: importSpares, isPending } = useImportSpares();
...
export default SpareImportModal;